...
namespace BookStoreApi.Services
{
    public class BooksService
    {
        ...
        public BooksService(IOptions<BookStoreDatabaseSettings> bookStoreDatabaseSettings)
        {
            ...
            var mongDataBase = mongoClient.GetDatabase(bookStoreDatabaseSettings.Value.DatabaseName);
            _booksCollection = mongDataBase.GetCollection<Book>(bookStoreDatabaseSettings.Value.BooksCollectionName);
        }
